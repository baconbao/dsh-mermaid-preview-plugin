...
export function apply(ctx, config) {
	...
	ctx.inject(["webServer"], (httpCtx) => {
		httpCtx.effect(() => httpCtx.webServer.tapIndex((html) => injectBootGlobals(html, enableLocalRender, resolveFallbackRenderUrl(config), resolveEnableFallback(config), DEFAULT_THUMB_MAX_HEIGHT, PLUGIN_VERSION)), "@baconbao/dsh-mermaid-image-preview: boot globals bootstrap");
